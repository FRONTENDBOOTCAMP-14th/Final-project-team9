...
- **Week 1-2:** 기획 구체화, 와이어프레임/디자인 시스템, DB 스키마 설계.
- **Week 3:** Supabase 연동 (인증, DB), 공통 UI 컴포넌트 개발.
- **Week 4:** 메인 페이지, 프로젝트 등록/검색/상세 페이지 UI 및 핵심 기능 구현.
- **Week 5:** 회원가입/로그인/찾기 기능 완성 및 **훅 분리 리팩토링**, 마이페이지 기능 구현.
- **Week 6:** 기능 통합 테스트, 반응형 디자인 점검, QA 및 배포 준비.
